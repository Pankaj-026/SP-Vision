...
const VideoTitle = ({ title, overview }) => {
  return (
    <>
      <div className="w-screen h-full absolute top-0 left-0 text-white bg-gradient-to-r from-[#0000008d] via-black/70 to-transparent px-10 md:px-12 py-16 flex flex-col justify-center gap-4 z-10">
